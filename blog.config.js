...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '23f6a82f-4a6d-801f-a39d-ec4916c6d9e4',
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 3600, // 更新缓存间隔 单位(秒)，默认1小时，调大节省Vercel资源 单位(秒)；即每个页面有60秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tssj', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力生活🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiao8867785.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '市场监测, 实时分析', // 网站关键词 英文逗号隔开
